...
export default function Navbar() {
    ...
    return(
        <nav className="invisible sm:visible mt-2 lg:mt-3 xl:mt-4">
            <div className="flex items-center justify-center gap-4 w-fit mx-auto px-8 md:gap-5 lg:gap-7 xl:gap-8 py-3 rounded-full">
                ...
                <button className="bg-black dark:bg-white px-3.5 py-0.5 rounded-full cursor-pointer" 
                    onClick={() => {
                        setIsDark(!isDark);
            ...
            <div className="visible sm:invisible w-full flex items-center justify-center">
                <Sheet >
