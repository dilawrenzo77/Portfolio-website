...
const web2Projects = [
   ...
   },
   {
	...
	projectLink: "binanceclonelawrence.netlify.app",
   ...
   },
   {
	...
	projectLink: "colognelanding.netlify.app",
   ...
   },
   {
	...
	projectLink: "lappclone.netlify.app",
   ...
   },
   {
	...
	projectLink: "restaurantlanding7.netlify.app",
